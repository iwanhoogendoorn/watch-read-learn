...
- **Books and manga** — Open Library and Google Books lookup, public ratings,
  store links, categories, per-book progress that can follow the page you are on
  in a linked PDF or epub.
...
`v1.1.0`); the workflow enforces this, runs the test suite, builds, and
attaches the assets.
...
src/
  ...
  constants.ts
  data/          schema · migrate · backup · adopt · store · episodes · notes
